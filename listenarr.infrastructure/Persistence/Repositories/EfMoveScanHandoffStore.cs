    ...
    IDbContextFactory<ListenArrDbContext> dbFactory) : IMoveScanHandoffStore
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            throw new PersistenceException("Failed to release a move scan handoff claim.", exception);
        }
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            throw new PersistenceException("Failed to requeue a move scan handoff.", exception);
        }
    }
